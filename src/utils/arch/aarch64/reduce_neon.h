        ...
        if (n_srcs <= 8) {                                               \
            ...
            case 1:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i],                   \
                                                UCC_RED_NEON_##UTAG##_LOAD(&p0[i])); \
                }                                                        \
                break;                                                   \
            case 2:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    UCC_RED_NEON_##UTAG##_VEC v0 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p0[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v1 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p1[i]);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i],                   \
                                                UCC_RED_NEON_##UTAG##_##UOP(v0, v1)); \
                }                                                        \
                break;                                                   \
            case 3:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v1 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p1[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v2 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p2[i]);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v1);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v2);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);             \
                }                                                        \
                break;                                                   \
            case 4:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v2 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p2[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v3 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p3[i]);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v1);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v2);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v3);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);             \
                }                                                        \
                break;                                                   \
            case 5:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v3 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p3[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v4 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p4[i]);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v1);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v2);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v3);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v4);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);             \
                }                                                        \
                break;                                                   \
            case 6:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v4 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p4[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v5 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p5[i]);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v1);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v2);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v3);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v4);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v5);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);             \
                }                                                        \
                break;                                                   \
            case 7:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v5 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p5[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v6 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p6[i]);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v1);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v2);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v3);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v4);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v5);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v6);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);             \
                }                                                        \
                break;                                                   \
            case 8:                                                      \
                for (i = 0; i + lanes <= count; i += lanes) {           \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v6 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p6[i]);           \
                    UCC_RED_NEON_##UTAG##_VEC v7 =                       \
                        UCC_RED_NEON_##UTAG##_LOAD(&p7[i]);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v1);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v2);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v3);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v4);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v5);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v6);           \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(v0, v7);           \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);             \
                }                                                        \
                break;                                                   \
            }                                                            \
            ...
            for (i = 0; i + lanes <= count; i += lanes) {               \
                ...
                unsigned j;                                              \
                for (j = 8; j < n_srcs; j++) {                          \
                    v0 = UCC_RED_NEON_##UTAG##_##UOP(                   \
                        v0, UCC_RED_NEON_##UTAG##_LOAD(&s[j][i]));      \
                }                                                        \
                UCC_RED_NEON_##UTAG##_STORE(&d[i], v0);                  \
            }                                                            \
        }                                                                \
...
#define UCC_RED_NEON_DEF_BTREE(CTYPE, DT, UTAG, OP, UOP)                    \
    static inline void                                                   \
    ucc_arch_reduce_neon_##DT##_##OP(void *dst,                         \
                                     const void * const *srcs,         \
                                     size_t count, unsigned n_srcs)     \
            ...
            case 3:                                                        \
                for (i = 0; i + lanes <= count; i += lanes) {             \
                    ...
                    UCC_RED_NEON_##UTAG##_VEC v2 =                         \
                        UCC_RED_NEON_##UTAG##_LOAD(&p2[i]);             \
                    UCC_RED_NEON_##UTAG##_STORE(&d[i],                     \
                        UCC_RED_NEON_##UTAG##_##UOP(                      \
                            UCC_RED_NEON_##UTAG##_##UOP(v0, v1), v2));    \
                }                                                          \
                break;                                                     \
            case 4:                                                        \
                for (i = 0; i + lanes <= count; i += lanes) {             \
                    ...
                    UCC_RED_NEON_##UTAG##_STORE(&d[i],                     \
                        UCC_RED_NEON_##UTAG##_##UOP(                      \
                            UCC_RED_NEON_##UTAG##_##UOP(v0, v1),          \
                            UCC_RED_NEON_##UTAG##_##UOP(v2, v3)));        \
                }                                                          \
                break;                                                     \
            case 5:                                                        \
                for (i = 0; i + lanes <= count; i += lanes) {             \
                    ...
                    UCC_RED_NEON_##UTAG##_STORE(&d[i],                     \
                        UCC_RED_NEON_##UTAG##_##UOP(                      \
                            UCC_RED_NEON_##UTAG##_##UOP(                  \
                                UCC_RED_NEON_##UTAG##_##UOP(v0, v1),      \
                                UCC_RED_NEON_##UTAG##_##UOP(v2, v3)),     \
                            UCC_RED_NEON_##UTAG##_##UOP(v4, v5)));        \
                }                                                          \
                break;                                                     \
            case 7:                                                        \
                for (i = 0; i + lanes <= count; i += lanes) {             \
                ...
                for (i = 0; i + lanes <= count; i += lanes) {             \
                    ...
                    UCC_RED_NEON_##UTAG##_STORE(&d[i],                     \
                        UCC_RED_NEON_##UTAG##_##UOP(                      \
                            ...
                            UCC_RED_NEON_##UTAG##_##UOP(                  \
                                UCC_RED_NEON_##UTAG##_##UOP(v4, v5),      \
                                UCC_RED_NEON_##UTAG##_##UOP(v6, v7))));   \
                }                                                          \
                break;                                                     \
            }                                                              \
        } else {                                                           \
...
/* INT8 */
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int8_t, int8, INT8, lxor, LXOR, TREE)
/* INT16 */
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int16_t, int16, INT16, lxor, LXOR, TREE)
/* INT32 */
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int32_t, int32, INT32, lxor, LXOR, TREE)
/* INT64 */
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(int64_t, int64, INT64, lxor, LXOR, TREE)
/* UINT8 */
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint8_t, uint8, UINT8, lxor, LXOR, TREE)
/* UINT16 */
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint16_t, uint16, UINT16, lxor, LXOR, TREE)
/* UINT32 */
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint32_t, uint32, UINT32, lxor, LXOR, TREE)
/* UINT64 */
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, max, MAX, BTREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, band, BAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, bor, BOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, bxor, BXOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, land, LAND, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, lor, LOR, TREE)
UCC_RED_NEON_DEF_REDUCE(uint64_t, uint64, UINT64, lxor, LXOR, TREE)
/* FLOAT32 */
UCC_RED_NEON_DEF_REDUCE(float, float32, FLOAT32, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(float, float32, FLOAT32, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(float, float32, FLOAT32, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(float, float32, FLOAT32, max, MAX, BTREE)
/* FLOAT64 */
UCC_RED_NEON_DEF_REDUCE(double, float64, FLOAT64, sum, SUM, TREE)
UCC_RED_NEON_DEF_REDUCE(double, float64, FLOAT64, prod, PROD, TREE)
UCC_RED_NEON_DEF_REDUCE(double, float64, FLOAT64, min, MIN, BTREE)
UCC_RED_NEON_DEF_REDUCE(double, float64, FLOAT64, max, MAX, BTREE)
