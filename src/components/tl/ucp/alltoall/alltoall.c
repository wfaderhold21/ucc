...
ucc_base_coll_alg_info_t
    ucc_tl_ucp_alltoall_algs[UCC_TL_UCP_ALLTOALL_ALG_LAST + 1] = {
        ...
        [UCC_TL_UCP_ALLTOALL_ALG_ONESIDED_PPN] =
            {.id   = UCC_TL_UCP_ALLTOALL_ALG_ONESIDED_PPN,
             .name = "onesided_ppn",
             .desc = "naive, linear one-sided implementation"},
...
ucc_status_t ucc_tl_ucp_alltoall_onesided_ppn_init(ucc_base_coll_args_t *coll_args,
                                               ucc_base_team_t *     team,
                                               ucc_coll_task_t **    task_h)
{
//    ucc_tl_ucp_team_t *tl_team = ucc_derived_of(team, ucc_tl_ucp_team_t);
